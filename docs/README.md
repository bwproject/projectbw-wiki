...
features:
  - title: 🔥 Версия сервера projectbw 🔥
    details: Наш сервер поддерживаются все последние версии Minecraft начиная от 1.21.Х до 26.Х.Х. У Нас есть разные режимы игры. У Нас есть Сервера в GMOD и BEAMNGMP
...
footer: Beautiful World Project © 2014-2026
---
